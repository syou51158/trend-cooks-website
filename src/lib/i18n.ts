  ...
  ja: {
    translation: {
      ...
      gallery: {
        ...
        photoNote: '※写真は随時追加予定',
        images: [
          { alt: '夜のTrend Cooks外観', category: '外観' },
          { alt: '昼の店内カフェ空間', category: '店内' },
          { alt: '夜のキャンドルが灯る店内', category: '店内' },
  ...
  en: {
    translation: {
      ...
      gallery: {
        ...
        images: [
          { alt: 'Trend Cooks storefront at night', category: 'Exterior' },
          { alt: 'Daytime cafe interior', category: 'Interior' },
          { alt: 'Candlelit evening interior', category: 'Interior' },
